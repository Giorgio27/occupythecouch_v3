...
export default function TutorialCtaSection() {
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/auth/signup" className="inline-block group">
                <Button
                  size="lg"
                  className="cine-btn text-base sm:text-lg h-12 sm:h-14 px-8 sm:px-10 md:px-12 animate-glow-pulse w-full sm:w-auto"
                >
              ...
              <Link href="/auth/signin" className="inline-block group">
                <Button
                  size="lg"
                  variant="outline"
                  className="cine-btn-ghost text-base sm:text-lg h-12 sm:h-14 px-8 sm:px-10 bg-transparent w-full sm:w-auto"
                >
