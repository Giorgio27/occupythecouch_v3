  ...
  return (
    <div className="cine-card-fit overflow-hidden">
      <div className="flex items-center gap-2 sm:gap-4 py-3 sm:py-4 px-3 sm:px-6 bg-primary text-primary-foreground">
        {/* # — w-8 sm:w-16 */}
        <div className="w-8 sm:w-16 text-center font-bold text-sm sm:text-base flex-shrink-0">
          #
        </div>
        {/* Title — flex-1 */}
        ...
        <div className="w-8 sm:w-28 text-center font-bold text-sm sm:text-base flex-shrink-0">
        ...
        <div className="w-8 sm:w-20 text-right font-bold text-sm sm:text-base flex-shrink-0">
          <span className="hidden sm:inline">
